(function () {
  ...
  //#endregion
  //#region node_modules/workbox-core/models/messages/messages.js
  var messages$1 = {
  ...
  var messageGenerator = process.env.NODE_ENV === 'production' ? fallback : generatorFunction;
  //#endregion
  ...
  //#endregion
  //#region node_modules/workbox-core/_private/assert.js
  var isArray = (value, details) => {
    if (!Array.isArray(value)) throw new WorkboxError('not-an-array', details);
  };
  ...
  //#endregion
  //#region node_modules/workbox-core/_private/logger.js
  var logger =
    process.env.NODE_ENV === 'production'
      ? null
      : (() => {
  ...
  //#endregion
  //#region node_modules/workbox-precaching/utils/printCleanupDetails.js
  /**
  ...
  //#endregion
  //#region node_modules/workbox-precaching/utils/printInstallDetails.js
  /**
   * @param {string} groupTitle
  ...
  async function cacheMatchIgnoreParams(cache, request, ignoreParams, matchOptions) {
    ...
    for (const cacheKey of cacheKeys)
      if (strippedRequestURL === stripParams(cacheKey.url, ignoreParams))
  ...
  var StrategyHandler = class {
    ...
    async cacheMatch(key) {
      ...
      if (process.env.NODE_ENV !== 'production')
        if (cachedResponse) logger.debug(`Found a cached response in '${cacheName}'.`);
    ...
    *iterateCallbacks(name) {
    ...
    async doneWaiting() {
      while (this._extendLifetimePromises.length) {
        ...
        const firstRejection = (await Promise.allSettled(promises)).find(
          (i) => i.status === 'rejected',
        );
  ...
  var PrecacheController = class {
    ...
    activate(event) {
      return waitUntil(event, async () => {
        ...
        if (process.env.NODE_ENV !== 'production') printCleanupDetails(deletedURLs);
        return { deletedURLs };
      });
    }
    /**
  ...
  //#endregion
  //#region node_modules/workbox-routing/utils/constants.js
  /**
    ...
    handleRequest({ request, event }) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        debugMessages.forEach((msg) => {
          if (Array.isArray(msg)) logger.log(...msg);
          else logger.log(msg);
        });
        logger.groupEnd();
      }
  ...
  //#endregion
  //#region node_modules/workbox-strategies/utils/messages.js
  var messages = {
  ...
  var CacheTimestampsModel = class {
    ...
    async setTimestamp(url, timestamp) {
      ...
      const tx = (await this.getDb()).transaction(CACHE_OBJECT_STORE, 'readwrite', {
        durability: 'relaxed',
      });
